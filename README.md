...
Key features include the ability to resize the form and all controls, as well as adjust the font size of the downloaded text verse(s) - facilitating a responsive user experience across different screen sizes. The userform is intuitive with navigational tooltips and spin buttons, improving user interaction. 
