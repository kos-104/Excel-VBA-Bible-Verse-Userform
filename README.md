...
**Tying them together**, data binding and commands are the mechanism the ViewModel uses to work with the View indirectly, rather than a layer of their own. List population and selection syncing for versions, books, and chapters follow this path faithfully, even where the command operations don't.
